            ...
            <div class="panel-body">
                <div class="responsive-table">
                    <table id="datatables-example" class="table table-striped table-bordered" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            <?php
                                $hostel = query("SELECT * FROM booking,hostel,owner WHERE hostel.hostel_id = booking.booking_hostel AND booking.booking_status='approved' AND owner.owner_email='$_SESSION[hostel_owner]'");
                                //confirm($hostel);
                                $id = 1;
